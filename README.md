...
<script src="https://cdn.jsdelivr.net/npm/@svgdotjs/svg.pathhandles.js/dist/svg.pathhandles.js"></script>
```

A bundle is also attached to every [release](https://github.com/svgdotjs/svg.pathhandles.js/releases).
